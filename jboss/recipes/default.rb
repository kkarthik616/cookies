...
bash "put_files" do
  code <<-EOH
  cd /tmp
  wget #{node['jboss']['http://download.jboss.org/jbossas/7.0/jboss-as-7.0.0.Final/jboss-as-web-7.0.0.Final.tar.gz']}
  
  tar xvzf #{jboss-as-web-7.0.0.Final}.tar.gz -C #{jboss_parent}
